...
class JointTreeItem : public QStandardItem {
 public:
  ...
  JointTreeItem(const char* name, const ULong& idxQ, const ULong& idxV,
                const hpp::floatSeq& q, const hpp::floatSeq& b,
                const ULong& nbDof, const NodesPtr_t& node);

  ~JointTreeItem();

  virtual QStandardItem* clone() const;

  virtual int type() { return QStandardItem::UserType + 3; }
...
class IntegratorWheel : public QSlider {
 ...
 public:
  IntegratorWheel(Qt::Orientation o, HppWidgetsPlugin* plugin, QWidget* parent,
                  gepetto::gui::MainWindow* main, JointTreeItem const* item,
                  int index);
...
class SliderBoundedJoint : public QSlider {
 ...
 public:
  SliderBoundedJoint(Qt::Orientation orientation, HppWidgetsPlugin* plugin,
                     QWidget* parent, gepetto::gui::MainWindow* main,
...
class JointItemDelegate : public QItemDelegate {
 ...
 public:
  JointItemDelegate(QPushButton* forceVelocity, HppWidgetsPlugin* plugin,
