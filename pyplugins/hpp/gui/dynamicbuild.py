...
class _DualSelect(object):
    ...
    def initActions(self):
        ...
        self.mainWindow.registerShortcut("Dynamic builder", "Grasp from current", action)
        ...
        self.mainWindow.registerShortcut("Dynamic builder", "Grasp from random", action)
        self.actions.append(action)
        ...
        self.mainWindow.registerShortcut("Dynamic builder", "Pregrasp from current", action)
        self.actions.append(action)
        ...
        self.mainWindow.registerShortcut("Dynamic builder", "Pregrasp from random", action)
        self.actions.append(action)
        ...
        self.mainWindow.registerShortcut("Dynamic builder", "Change handle used", action)
        self.actions.append(action)
